...
main() {
  ...
  app.post('/api/category/delete',    (HttpContext ctx) => CartAction.handleCategoryDelete(ctx));
  // TAGS
  ...
  app.post('/api/tag/delete',         (HttpContext ctx) => CartAction.handleTagDelete(ctx));
  // SYSTEM
